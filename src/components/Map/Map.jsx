...
const Map = ({setCoord, setBounds, coord, places, setChildClicked, weatherData}) => {
    ...
    return (
        <div className={classes.mapContainer}>
            <GoogleMapReact
                 bootstrapURLKeys={{ key: 'AIzaSyDd_PY_yW_SA3lG3KeyUZjL9iwfkr9ZOEA'}}
                 defaultCenter={coord}
                 center={coord}
                 defaultZoom={14}
                 margin={[50, 50, 50, 50]}
            ...
            >
                    ...
                    >
                        {
                            !isDesktop ? (
                                ...
                                <Paper elevation={3} className={classes.paper}>
                                    <Typography className={classes.typogrpahy} variant='subtitle2'gutterBottom>
                                        {place.name}
                                    </Typography>
                ...
                {weatherData?.list?.map((data, i) => (
                   <div ket={i} lat={data.coord.lat} lng={data.coord.lon}>
